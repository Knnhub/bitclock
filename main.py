...
class CryptoApp(tk.Tk):
    ...
    def show_detail_page(self, coin):
        ...
        btn_ema = tk.Button(
            ...
            fg='black',
            relief=tk.FLAT,
            command=self.open_ema_settings
        )
        ...
        try:
            ...
            if ema_data:
                ...
                for s in signals:
                    ...
                    signal_id = f"{symbol}_{signal_type}_{direction}"
    ...
    def open_ema_settings(self):
        ...
        tk.Label(
            win,
            text="กรอกตัวเลข EMA คั่นด้วยลูกน้ำ (,)\n(เช่น: 12, 26, 50 หรือ 7, 14, 21)\n*มีผลกับกราฟ TradingView*",
            font=('Arial', 10),
            bg=BG_COLOR,
            fg=TEXT_COLOR
        ).pack(pady=10)
